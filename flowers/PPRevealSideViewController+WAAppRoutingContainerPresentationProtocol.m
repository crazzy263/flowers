...
- (BOOL)waapplink_selectController:(UIViewController *)controller animated:(BOOL)animated {
    ...
    if ([self.rootViewController isKindOfClass:[UINavigationController class]]) {
        ...
        // If the navigation controller of the controller we are trying to place is the same then juste close the MatchReveal and let the router handles the stack
